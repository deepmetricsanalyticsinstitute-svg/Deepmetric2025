...
export const Navbar: React.FC<NavbarProps> = ({ currentView, onChangeView, user, onLogout, pendingRequestCount = 0 }) => {
  ...
  const navItems = [
    ...
    { label: 'Courses', view: View.COURSES },
  ];
      ...
      <nav className="bg-white border-b border-gray-200 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center cursor-pointer" onClick={() => onChangeView(View.HOME)}>
              <div className="flex-shrink-0 flex items-center gap-2">
                <div className="h-8 w-8 bg-indigo-600 rounded-lg flex items-center justify-center">
                   <span className="text-white font-bold text-xl">D</span>
                </div>
                <span className="font-bold text-xl text-gray-900 hidden sm:block">Deepmetric</span>
              </div>
            </div>
